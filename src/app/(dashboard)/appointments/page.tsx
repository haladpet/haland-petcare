  ...
  return (
    <div className="p-6 max-w-5xl mx-auto">
      ...
      {loading ? (
        ...
        <div className="space-y-3">
          {appointments.map((apt) => (
            <Card key={apt.id} className="p-4 hover:bg-accent/50 transition-colors">
      ...
      {!loading && appointments.length === 0 && (
        <Card className="p-8 text-center text-muted-foreground">No appointments found.</Card>
      )}
        ...
        <DialogContent>
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <Input value={form.pet_id} onChange={(e) => setForm({ ...form, pet_id: e.target.value })} placeholder="Pet UUID (optional)" />
            </div>
            <div>
              <label className="text-sm font-medium">Doctor ID</label>
              <Input value={form.doctor_id} onChange={(e) => setForm({ ...form, doctor_id: e.target.value })} placeholder="Doctor UUID (optional)" />
            </div>
            <div>
