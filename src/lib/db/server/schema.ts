...
export const medicalRecords = pgTable(
  ...
  {
    id: uuid("id").defaultRandom().primaryKey(),
    clinic_id: uuid("clinic_id").notNull().references(() => clinics.id, { onDelete: 'restrict' }),
  ...
  (table) => ({
    ...
    customer_idx: index("medical_records_customer_id_idx").on(table.customer_id),
  }),
);
...
export const prescriptions = pgTable(
  "prescriptions",
  {
    ...
    customer_id: uuid("customer_id").notNull().references(() => customers.id, { onDelete: 'restrict' }),
    pet_id: uuid("pet_id").notNull().references(() => pets.id, { onDelete: 'restrict' }),
    prescribed_by: uuid("prescribed_by").references(() => serverUsers.id, { onDelete: 'set null' }),
...
export const hospitalizations = pgTable(
  "hospitalizations",
  {
    ...
    customer_id: uuid("customer_id").notNull().references(() => customers.id, { onDelete: 'restrict' }),
    pet_id: uuid("pet_id").notNull().references(() => pets.id, { onDelete: 'restrict' }),
    cage_id: uuid("cage_id").references(() => cages.id, { onDelete: 'set null' }),
  ...
  (table) => ({
    ...
    customer_idx: index("hospitalizations_customer_id_idx").on(table.customer_id),
  }),
);
...
export const invoices = pgTable(
  ...
  (table) => ({
    clinic_idx: index("invoices_clinic_id_idx").on(table.clinic_id),
