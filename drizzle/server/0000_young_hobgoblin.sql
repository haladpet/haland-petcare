...
CREATE TABLE "server_users" (
	...
	"updated_at" timestamp DEFAULT now() NOT NULL,
	"deleted_at" timestamp,
	CONSTRAINT "server_users_role_check" CHECK ("server_users"."role" in ('OWNER', 'DOCTOR', 'STAFF', 'CUSTOMER')),
	CONSTRAINT "server_users_status_check" CHECK ("server_users"."status" in ('ACTIVE', 'INACTIVE', 'SUSPENDED'))
);
--> statement-breakpoint
...
CREATE INDEX "server_users_email_idx" ON "server_users" USING btree ("email");--> statement-breakpoint
CREATE INDEX "server_users_clinic_id_idx" ON "server_users" USING btree ("clinic_id");--> statement-breakpoint
